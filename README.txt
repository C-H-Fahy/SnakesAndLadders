...
As discussed(via Email with Barry Ip), I used turtle to draw the Snakes And Ladders instead of using the GIFs given, to allow
...
which may cause Turtle to non-responsive sometimes due to unknown reasons sometimes that seem to have nothing to do with my code.
